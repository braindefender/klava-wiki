...
то вы просто нажимаете `LGui` один раз.
...
Либо, нажимать какую-то другую клавишу, вызывая этим совсем ненужный шорт-кат.

Решить это можно, назначив отдельную клавишу, в сочетании с которой
точно не будет зарегистрировано никакого действия (например, F13-F24).

В моей прошивке [Wellum](/layouts/combined/wellum.md) реализован функционал
